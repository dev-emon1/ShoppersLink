    ...
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="grid md:grid-cols-2 gap-5">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            type="text"
            maxLength={MAX_TITLE}
            className={`border border-border rounded-md p-2 text-sm outline-none focus:ring-1 ${
              errors?.metaTitle ? "focus:ring-red" : "focus:ring-main"
            }`}
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            type="text"
            className={`border border-border rounded-md p-2 text-sm outline-none focus:ring-1 ${
              errors?.metaKeywords ? "focus:ring-red" : "focus:ring-main"
            }`}
      ...
      <div className="flex flex-col gap-2">
        ...
        <textarea
          ...
          maxLength={MAX_DESC}
          className={`border border-border rounded-md p-2 text-sm outline-none focus:ring-1 ${
            errors?.metaDescription ? "focus:ring-red" : "focus:ring-main"
          } resize-none`}
